...
//Play Channels - tablice na ktorych beda zapisywane sekwencje dzwieku wraz z czasem odtworzenia. W nich przechowywane sa nagrania
let channel1:any[] =[];
let channel2:any[] =[];
let channel3:any[] =[];
let channel4:any[] =[];

//Booleany odpowiedzialne za zezwolenie na nagrywanie kanalu - jezeli jest na true to zapisuje . Domyslnie nagrywanie jest wylaczone czyli false.
...
let recordStartTime:any;//Time stamp potrzebny do obliczenia roznicy miedzy czasem uruchomienia strony a czasem rozpoczecia nagrywania
...
//Odtworz Channel1 -odtwarza zapisany dziwek poprzez uzycie petli for each
